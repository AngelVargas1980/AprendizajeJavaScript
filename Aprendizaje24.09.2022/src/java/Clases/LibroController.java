...
public class LibroController {
    ...
    public LibroController(){
        this.tablaCliente = new Libro[100];
        this.indiceArray=0;
    }
    
     public void guardarCliente(Libro cliente){
    ...
    public String guardarCliente2(Libro cliente){        
        String sql = "INSERT INTO sitemabibliote0.cliente(numero_libro, nombre, pasta, editorial, publicacion, genero_idgenero) ";
             sql += " VALUES(?,?,?,?,?,?)";              
       try{     
            abrirConexion();
    ...
    public void getClientes2(StringBuffer respuesta){   
        String sql="select * from sitemabibliote0.cliente";
        try{
        abrirConexion();
