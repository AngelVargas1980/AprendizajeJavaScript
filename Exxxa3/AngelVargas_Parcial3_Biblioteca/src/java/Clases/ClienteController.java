...
public class ClienteController {
    ...
    public String guardarCliente2(Cliente cliente){        
        String sql = "INSERT INTO biblioteca.cliente(numero_libro, nombre_libro, pasta, editorial, publicacion, genero_idgenero) ";
             sql += " VALUES(?,?,?,?,?,?)";              
       try{     
            abrirConexion();
    ...
    public void getClientes2(StringBuffer respuesta){   
        String sql="select * from biblioteca.cliente";
        try{
        abrirConexion();
